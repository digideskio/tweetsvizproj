...
*/
 (function() {
     ...
     var t, y = document,
         ...
         Za, $a, Kb = {}, tb = 0,
         db, E, cb, va, ub, A, sa = function() {}, V = [],
         ab = 0,
         Ja = "div",
         Q = "none",
         Ob = /^[0-9]+$/,
         Pb = "stroke-width",
         eb, Ra, pb, qb, rb, Xa, fb, gb, Db, Eb, sb, Fb, Gb, F = {}, R = I.Highcharts = I.Highcharts ? ra(16, !0) : {};
     cb = function(a, b, c) {
         if (!r(b) || isNaN(b))
             return "Invalid date";
     ...
     E = {
         ...
         credits: {
             enabled: !0,
             text: "",
             href: "http://tweetsviz.appspot.com",
             position: {
                 align: "right",
                 x: -10,
                 verticalAlign: "bottom",
         ...
         buildText: function(a) {
             ...
             !f && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b),
                 e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), p(e, function(e, f) {
                     ...
                     p(g, function(e) {
                         if (e !== "" || g.length === 1) {
                             var o = {}, m = y.createElementNS(xa, "tspan"),
                                 p;
     ...
     R.PlotLineOrBand.prototype = {
         render: function() {
             ...
             if (s && s.length && (a.svgElem = n = t.path(s).attr(q).add(), x))
     ...
     la.prototype = {
         ...
         getOffset: function() {
             var a = this,
                 ...
                 y, z, A, B, na = h === 2 ? c.fontMetrics(s.style.fontSize).b : 0;
     ...
     q(R.Pointer.prototype, {
         ...
         pinch: function(a) {
             var b = this,
                 ...
                 i = b.hasZoom,
                 j = b.selectionMarker,
                 k = {}, l = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick),
                 o = {};
